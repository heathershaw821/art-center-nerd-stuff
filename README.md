...
### Unit 1: Assembly & Orientation

* **Lesson 1:** Build the chassis. Identify each part and what it does.
* **Lesson 2:** Finish building. Power test. Upload a “blink” to confirm wiring works.
  - [Arduino IDE Software](https://www.arduino.cc/en/software/#ide)

### Unit 2: Arduino and Robotics Concepts Overview

- **Lesson 1:** Intro to what Arduino is, serial basics: `Serial.print()`, Hello World, debugging.
...
- **Lesson 2:** Video presentation + lecture on robotics fundamental concepts
...
### Unit 3: Sensors and Servos

- **Lesson 1:** How servo motors work
  - [Controlling Self Driving Cars](https://youtu.be/4Y7zG48uHRo)
- **Lesson 2:** Ultrasonic sensors
  - [Ultrasonic Sensor Module](https://youtu.be/KGwtit2bFyo)

### Unit 4: Motors, Remote Control, and the bridge between controlled and semi-autonomous machines

- **Lesson 1:** Read IR remote signals using a library. Print codes to Serial Monitor. Learn about motor drivers.
...
- **Lesson 2:** Remote control mode: UP = forward, DOWN = backward, LEFT = spin left, RIGHT = spin right.  
  *(Reward = they can drive their robot like an RC car).*
...
### Unit 1: Raspberry Pi & the separation of decision making from control modules

- **Lesson 1:** Getting comfortable with what the Raspberry Pi / Linux are, and setting up our control interfaces
  - [What Is Linux? - Explained for Beginners](https://youtu.be/eQbIxEw3AI0)
...
- Students **see the robot get smarter** each unit: from blinking → moving → controlled → sensing → thinking.
